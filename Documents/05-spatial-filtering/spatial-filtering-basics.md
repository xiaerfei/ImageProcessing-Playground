...
> **动手验证**:[`Ch03_Spatial_Filtering/20_convolution_basics.py`](../../Python-Prototyping/Ch03_Spatial_Filtering/20_convolution_basics.py)
> 把本篇每个数字都跑了一遍(冲激响应、五种补边、秩、计时、溢出统计)。
