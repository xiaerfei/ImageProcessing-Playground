...
**② `detail` 的均值必然在 0 附近。**
实测 detail 均值 **−0.000409**,而 f 的均值 129.0607、blur 的均值 129.0611,
两者只差 **4.09e-04**。原因在 [02-smoothing.md 第二节](02-smoothing.md#二高斯滤波)讲过的那条:
**高斯核的和是 1,「平均」不改变整体亮度**,所以减出来的东西只能在 0 上下对称摆。
