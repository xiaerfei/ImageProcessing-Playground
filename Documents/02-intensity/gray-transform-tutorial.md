...
> 这一块单独放在文末「附:彩色反转为什么会发青蓝」,可以先跳过,回头慢慢看。
...
### 附.1 直接原因:每个通道各自取反,就是每个像素换成它的补色
...
### 附.2 精确一点:色相准准地转 180°,但饱和度和明度会跟着变
...
对应脚本:[Python-Prototyping/Ch01_02_Fundamentals/gray-transform.py](../../Python-Prototyping/Ch01_02_Fundamentals/gray-transform.py),
跑一次会出两张图板:
