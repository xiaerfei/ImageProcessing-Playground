...
用法:
    ...
    .venv/bin/python Ch03_Spatial_Filtering/14_interactive_intensity.py --image ../Assets/test-images/page.png
    .venv/bin/python Ch03_Spatial_Filtering/14_interactive_intensity.py --save   # 只存一张静态图,不开窗口
"""
