...
| `23_sharpening.py` | 3.6 锐化:一阶 vs 二阶导数的一维演示;拉普拉斯 = 横竖两个二阶导相加(−4 = −2 + −2);二阶能直接加、一阶必须开方(135° 边 gx+gy = −0.00);⚠️ 八邻域 −8 没折算对角 √2 步长,各向同性反不如四邻域(9.75% vs 8.94%,折算版 −6 是 7.92%);拐点 = 一阶峰顶 = 二阶零点,|二阶| 最大的两处都不是边(halo 就长在那儿);锐化核 = 单位核 − 拉普拉斯(符号自检);USM 三步;⚠️ 小半径 USM ≈ 拉普拉斯锐化(相关 0.9918);过冲 [50,200]→[−100,350];噪声放大 5.4× vs 1.86×;|gx|+|gy| 省开方;Prewitt/Sobel/Scharr 方向误差 0.549°/0.275°/0.068° |
