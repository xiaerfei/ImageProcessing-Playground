...
| `23_sharpening.py` | 3.6 锐化:一阶 vs 二阶导数的一维演示;锐化核 = 单位核 − 拉普拉斯(符号自检);USM 三步;⚠️ 小半径 USM ≈ 拉普拉斯锐化(相关 0.9918);过冲 [50,200]→[−100,350];噪声放大 5.4× vs 1.86×;|gx|+|gy| 省开方;Prewitt/Sobel/Scharr 方向误差 0.549°/0.275°/0.068° |
